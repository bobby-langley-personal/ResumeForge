...
export async function POST(req: NextRequest) {
  try {
    ...
    const lastName = user?.lastName || candidateName.split(' ').pop() || 'Resume';
    ...
    const filename = `${lastName}_Resume_${formattedCompany}_${formattedRole}.pdf`;

    // Generate PDF using ResumePDF component (JSX syntax instead of React.createElement)
